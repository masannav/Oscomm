...
define('TABLE_HEADING_OPT_NAME', 'Nombre de la Opcion');
define('TABLE_HEADING_OPT_VALUE', 'Valor de la Opcion');
...
define('TEXT_OPTION_ID', 'ID de Opcion');
define('TEXT_OPTION_NAME', 'Nombre de Opcion');
?>